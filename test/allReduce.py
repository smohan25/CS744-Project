...
t = torch.tensor(sparse.random(1000, 10000, density=args.density).A, dtype=torch.float) \
...
gatherListIndices = [torch.zeros([2, nnz_tensor.item()], dtype=torch.long) for _ in range(world_size)]
